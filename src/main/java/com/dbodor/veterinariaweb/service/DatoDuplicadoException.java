 ...
 * (HU-01 criterios 2 y 3, HU-06 criterio 2, HU-16 criterio 2). Lleva el
 * nombre del campo para que el controlador pueda senalar el error justo
 * en ese campo del formulario.
 */
public class DatoDuplicadoException extends RuntimeException {
    ...
    public static DatoDuplicadoException nombreServicio() {
        return new DatoDuplicadoException("nombre", "Ya existe un servicio con ese nombre");
    }
}